...
encoded = Conv2D(8,(8,8), activation='relu', padding='same')(input_img)
#encoded = MaxPooling2D(pool_size=(2,2), padding='same')(encoded)
#encoded = Conv2D(16,(3,3), activation='relu', padding='same')(encoded)
encoded = Conv2D(16,(33,33), activation='relu')(encoded)
#encoded = MaxPooling2D(pool_size=(2,2), padding='same')(encoded)
encoded = Conv2D(32,(17,17), activation='relu')(encoded)
encoded = Conv2D(64,(17,17), activation='relu', padding='same')(encoded)
#encoded = MaxPooling2D(pool_size=(2,2), padding='same')(encoded)

# Decoding part

#decoded = Conv2D(8,(3,3), activation='relu', padding='same')(encoded)
decoded = Conv2DTranspose(32,(17,17), activation='relu')(encoded)
#decoded = UpSampling2D((2,2))(decoded)
decoded = Conv2D(16,(17,17), activation='relu', padding='same')(decoded)
#decoded = UpSampling2D((2,2))(decoded)
#decoded = Conv2D(16,(3,3), activation='relu')(decoded)
decoded = Conv2DTranspose(8,(33,33), activation='relu')(decoded)
decoded = Conv2D(8,(33,33), activation='relu', padding='same')(decoded)
#decoded = UpSampling2D((2,2))(decoded)
decoded = Conv2D(1,(16,16), activation='relu', padding='same')(decoded)
...
# save trained model
autoencoder.save('./'+keyward+'_convae'+str(epochs)+'_inc.h5')
